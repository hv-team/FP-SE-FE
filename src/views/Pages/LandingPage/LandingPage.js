...
class LandingPage extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Header/>
        <div className="app align-items-center landing-page">
          <div className="container-fluid" id="part1">
            <div className="row">
              <div className="col-6" id="part1-1">
                ...
                <button type="button" className="btn btn-light btn-lg">Register Now</button>
              </div>
              <div className="col-6">
          ...
          <div className="container-fluid" id="part2">
            <div className="col-12">
              <h2 className="bring-business">Bring Your Business to <span
                className="bold underline">Another Level</span></h2>
            </div>
            <div className="row">
              <div className="col-4">
          ...
          <div className="container-fluid" id="part4">
            <div className="row">
              ...
              <div className="col-6">
                <button type="button" className="btn btn-light btn-lg yes-ready">Yes, I'm Ready</button>
              </div>
            </div>
          </div>
        </div>
